...
layout: '@docsLayout'
title: 'Introduction'
metaDescription: 'Learn how to use Signalize JavasScript framework in no time. Signalize is a client-side, module based, platform-focused, dependecy-less javascript framework designed for swift web development with minimum javascript.'
---
...
- It is caused by the requests amount
