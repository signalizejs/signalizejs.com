...
Directives can be used only within [web components](/plugins/signalizejs-components) and are initialized on DOM ready and after the component is constructed.
